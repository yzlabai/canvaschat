  ...
  const cleanedMessages = messages
    .map((message) => {
      ...
      if (message.role === "assistant") {
        const cleanedMessage: MyUIMessage = { ...message }
    ...
    .filter((message): message is MyUIMessage => message !== null)
 ...
 */
export function messageHasToolContent(message: MyUIMessage): boolean {
  return !!(
