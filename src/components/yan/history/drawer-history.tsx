...
import { ConversationWithStats } from "@/lib/chat-store/types"
import {
  CheckIcon,
  MagnifyingGlassIcon,
  PencilSimpleIcon,
...
type DrawerHistoryProps = {
  chatHistory: ConversationWithStats[]
...
export function DrawerHistory({
  ...
  const handleEdit = useCallback((chat: ConversationWithStats) => {
            ...
            >
              ...
              >
                ...
                <span className="mr-2 text-xs font-normal text-gray-500">
                  {formatDate(chat?.created_at?.toISOString?.() ?? chat?.created_at as any)}
                </span>
              </Link>
    ...
    <Drawer open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DrawerContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Here is the list of your past conversations.
          </DialogDescription>
        </DialogHeader>
        <div className="flex h-dvh max-h-[80vh] flex-col">
          <div className="border-b p-4 pb-3">
            <div className="relative">
              ...
              />
              <MagnifyingGlassIcon className="absolute top-1/2 left-2.5 h-3.5 w-3.5 -translate-y-1/2 transform text-gray-400" />
            </div>
          </div>
