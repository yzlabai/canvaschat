...
import CopyToClipboard from '@/components/copyit'
          ...
          return (
            <ErrorBoundary>
              <div className='flex h-[350px] w-full items-center justify-center'>
                <div className='text-text-secondary'>SVG content is not available.</div>
              </div>
            </ErrorBoundary>
          )
        }
  ...
  return (
    <div className={cn(
      ...
      <div className='flex h-9 items-center justify-between px-4'>
        <div className='text-muted-foreground py-1 pr-2 font-mono text-xs'>{languageShowName}</div>
